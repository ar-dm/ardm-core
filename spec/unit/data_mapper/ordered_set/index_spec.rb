...
describe 'DataMapper::OrderedSet#index' do
  ...
  context 'when the entry is not present' do
    ...
    include_examples 'DataMapper::OrderedSet#index when the entry is not present'
  end
  ...
  context 'when 1 entry is present' do
    ...
    include_examples 'DataMapper::OrderedSet#index when 1 entry is present'
  end
  ...
  context 'when 2 entries are present' do
    ...
    include_examples 'DataMapper::OrderedSet#index when 2 entries are present'
  end
end
